...
async function getDisenoInvestigacionById(req, res) {
  try {
    ...
    const sql =
      "SELECT * FROM DISENO_INVESTIGACION WHERE idDisenoInvestigacion = $1";
    const params = [id];
...
async function createDisenoInvestigacion(req, res) {
  try {
    ...
    const sql =
      "INSERT INTO DISENO_INVESTIGACION (tipo) VALUES ($1) RETURNING idDisenoInvestigacion";
    const params = [tipo];
...
async function updateDisenoInvestigacion(req, res) {
  try {
    ...
    const sql2 =
      "UPDATE DISENO_INVESTIGACION SET tipo = $1 WHERE idDisenoInvestigacion = $2";
...
async function deleteDisenoInvestigacion(req, res) {
  try {
    ...
    const sql2 =
      "UPDATE DISENO_INVESTIGACION SET active = $1 WHERE idDisenoInvestigacion = $2";
