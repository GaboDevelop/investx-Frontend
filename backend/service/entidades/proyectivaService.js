...
async function createProyectiva(req, res) {
  try {
    ...
    const sql =
      "INSERT INTO PROYECTIVA (idUnidadEstudio, idDisenoInvestigacion) VALUES ($1, $2) RETURNING idProyectiva";
...
async function updateProyectiva(req, res) {
  try {
    ...
    const sql2 =
      "UPDATE PROYECTIVA SET idUnidadEstudio = $1, idDisenoInvestigacion = $2  WHERE idProyectiva = $3";
