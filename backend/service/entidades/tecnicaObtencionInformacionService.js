...
async function getTecnicaObtencionInformacionById(req, res) {
  try {
    ...
    const sql =
      "SELECT * FROM TECNICA_OBTENCION_INFORMACION WHERE idTecnicaObtencionInformacion = $1";
    const params = [id];
...
async function createTecnicaObtencionInformacion(req, res) {
  try {
    ...
    const sql =
      "INSERT INTO TECNICA_OBTENCION_INFORMACION (tecnica) VALUES ($1) RETURNING idtecnicaObtencionInformacion";
...
async function updateTecnicaObtencionInformacion(req, res) {
  try {
    ...
    const sql2 =
      "UPDATE TECNICA_OBTENCION_INFORMACION SET tecnica= $1 WHERE idTecnicaObtencionInformacion = $2";
...
async function deleteTecnicaObtencionInformacion(req, res) {
  try {
    ...
    const sql2 =
      "UPDATE TECNICA_OBTENCION_INFORMACION SET active = $1 WHERE idTecnicaObtencionInformacion = $2";
