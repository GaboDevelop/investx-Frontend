...
async function getTipoInvestigacionById(req, res) {
  try {
    ...
    const sql =
      "SELECT * FROM TIPO_INVESTIGACION WHERE idTipoInvestigacion = $1";
    const params = [id];
...
async function getTiposInvestigacion(req, res) {
  try {
    const sql = "SELECT * FROM TIPO_INVESTIGACION";
    const TiposInvestigacion = await client
      .query(sql)
      .then(response => {
        res.json({
          data: response.rows
...
async function updateTipoInvestigacion(req, res) {
  try {
    ...
    const sql2 =
      "UPDATE TIPO_INVESTIGACION SET tipo = $1 WHERE idTipoInvestigacion = $2";
...
async function deleteTipoInvestigacion(req, res) {
  try {
    ...
    const sql2 =
      "UPDATE TIPO_INVESTIGACION SET active = $1 WHERE idTipoInvestigacion = $2";
