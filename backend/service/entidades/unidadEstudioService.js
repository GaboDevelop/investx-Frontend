...
async function createUnidadEstudio(req, res) {
  try {
    ...
    const sql =
      "INSERT INTO UNIDAD_ESTUDIO (idPoblacion, idMuestra, descripcion) VALUES ($1, $2, $3) RETURNING idunidadestudio";
...
async function updateUnidaEstudio(req, res) {
  try {
    ...
    const sql2 =
      "UPDATE UNIDAD_ESTUDIO SET idPoblacion = $1, idMuestra = $2, descripcion = $3 WHERE idUnidadEstudio = $4";
...
async function deleteUnidadEstudio(req, res) {
  try {
    ...
    const sql2 =
      "UPDATE UNIDAD_ESTUDIO SET active = $1 WHERE idUnidadEstudio = $2";
