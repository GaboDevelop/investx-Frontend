...
async function getCondicionMetodologicaById(req, res) {
  try {
    ...
    const sql =
      "SELECT * FROM CONDICION_METODOLOGICA WHERE idCondicionMetodologica = $1";
    const params = [id];
...
async function createCondicionMetodologica(req, res) {
  try {
    ...
    const sql =
      "INSERT INTO CONDICION_METODOLOGICA (idTemaInvestigacion, poblacionAccesible, abordajePosible, instrumentoMedicion, estudiosPrevios) VALUES ($1, $2, $3, $4, $5)";
    const params = [
      idTemaInvestigacion,
      poblacionAccesible,
      abordajePosible,
...
async function updateCondicionMetodologica(req, res) {
  try {
    ...
    const sql2 =
      "UPDATE CONDICION_METODOLOGICA SET idTemaInvestigacion = $1, poblacionAccesible = $2, abordajeAccesible = $3, instrumentoMedicion = $4, estudiosPrevios = $5 WHERE idCondicionMetodologica = $6";
    const params2 = [
      idTemaInvestigacion,
      poblacionAccesible,
      abordajeAccesible,
...
async function deleteCondicionMetodologica(req, res) {
  try {
    ...
    const sql2 =
      "UPDATE CONDICION_METODOLOGICA SET active = $1 WHERE idCondicionMetodologica = $2";
