...
async function getNivelInvestigacionById(req, res) {
  try {
    ...
    const sql =
      "SELECT * FROM NIVEL_INVESTIGACION WHERE idNivelInvestigacion = $1";
    const params = [id];
...
async function getNivelesInvestigacion(req, res) {
  try {
    const sql = "SELECT * FROM NIVEL_INVESTIGACION";
    const data = [];
    const NivelesInvestigacion = await client
      .query(sql)
      .then(response => {
        res.json({
          data: response.rows
...
async function updateNivelInvestigacion(req, res) {
  try {
    ...
    const sql2 =
      "UPDATE NIVEL_INVESTIGACION SET nivel = $1 WHERE idNivelInvestigacion = $2";
...
async function deleteNivelInvestigacion(req, res) {
  try {
    ...
    const sql2 =
      "UPDATE NIVEL_INVESTIGACION SET active = $1 WHERE idNivelInvestigacion = $2";
