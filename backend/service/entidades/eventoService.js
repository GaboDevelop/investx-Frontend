...
async function createEvento(req, res) {
    ...
    try {
        ...
        const sql = 'INSERT INTO EVENTO (idClaseEvento, evento) VALUES ($1, $2)';
        const params = [idClaseEvento, evento];
...
async function updateEvento(req, res) {
    ...
    try {
        ...
        if (eventos.length = 0) { 
            ...
            const sql2 = 'UPDATE EVENTO SET idClaseEvento = $1, evento = $2  WHERE idEvento = $3';
